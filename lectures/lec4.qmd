...
Cf. Manuel Kauers, How to use a Cylindrical Algebraic Decomposition.

## CAD Figure   

![](figures/kauers-ball-cad.png){width=80% align="center"}
...
- Adapt CAD to check polynomial positivity in single exp. time.
...
__Output:__ Is $p = \sigma_1^2 + \cdots + \sigma_k^2$ for some $\sigma_1, \ldots, \sigma_k \in \Re[x_1, \ldots, x_n]$.
